...
def check_stocks_combined(stocks_file):
    ...
    for stock in stocks:
        print(f"Processing stock: {stock}")  # Display stock being processed
        try:
            ...
            # Check if there is enough data (2 years)
            if len(data) < 252:  # A typical year has about 252 trading days
