...
def check_stocks_combined(stocks_file):
    ...
    for stock in stocks:
        ...
        latest_macd = data['MACD'].iloc[-1]  # Get the latest MACD value
        latest_signal = data['Signal'].iloc[-1]  # Get the latest Signal value
        ...
        csv_data.append([
            ...
            latest_macd, latest_signal, latest_rsi
        ])
